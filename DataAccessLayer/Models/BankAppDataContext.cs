...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Country>(entity =>
        {
            ...
            entity.Property(e => e.CountryLabel).HasMaxLength(100);
        });
        ...
        {
            entity.Property(e => e.FreqeuncyLabel).HasMaxLength(100);
            entity.Property(e => e.FrequencyCode).HasMaxLength(2);
        });

        modelBuilder.Entity<Gender>(entity =>
        {
            entity.Property(e => e.GenderCode).HasMaxLength(2);
            entity.Property(e => e.GenderLabel).HasMaxLength(100);
        });
